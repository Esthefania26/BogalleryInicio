...
<html lang="es">
  ...
  <a href="../../Reportes/Detalle2.php" class="btn btn-primary">Ver detalles </a>
    <br> 
    <br>
...
$sql = $conexion -> query("SELECT * FROM  planes
    ...
    while ($resultado = $sql->fetch_assoc()) {
        ...
        <tr>
            ...
            <th>
            <a href="Editarform.php?Id=<?php echo $resultado['Id_planes']; ?>" class="btn btn-warning">Editar</a>


                <a href="../CRUD/EliminarDatos.php?Id=<?php echo $resultado['Id_planes']; ?>" class="btn btn-danger">Eliminar</a>
            </th>
