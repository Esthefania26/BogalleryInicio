...
<div class="conteiner-fluid">
    ...
    <form  action="" method="GET"> <button class="btn btn-outline-onfo" type="submit" name="mostrartodo">Mostrar Todo</button>
     ...
     <h1 class="text-center bg-dark text-white p-3 rounded">Lugares Registrados</h1>
        <a href="../crudj/index.php" class="btn btn-dark boton">Regresar</a>
        <a  class="btn btn-success boton" href="GenerarExcel.php">Excel</a>
    ...
    <table id="tabla" class="table table-bordered table-responsive table-striped">
  <thead>
    <tr>
      ...
      include_once "../crudj/conexion.php";
